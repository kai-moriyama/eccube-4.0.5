...
class DeliveryController extends AbstractController
{
    ...
    public function __construct(MailService $mailService, BaseInfoRepository $baseInfoRepository, CustomerAddressRepository $customerAddressRepository)
    {
    ...
    public function edit(Request $request, $id = null)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            //メール情報をmailServiceに渡す
            $this->mailService->sendNewDeliveryNotificationMail($Customer, $CustomerAddress);
